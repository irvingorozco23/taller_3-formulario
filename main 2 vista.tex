...
\begin{titlepage}
    ...
    {\large Tuxtla Gutiérrez, Chiapas viernes  17 de octubre del 2025}
\end{titlepage}
...
% --- INICIO: SECCIÓN DE IMAGEN ADICIONAL ---
% Este es el nuevo bloque de código que pediste.
% Cambia el título y el nombre del archivo 'Img/nueva_imagen.png'

\section*{vista controlador }
el modelo vista controlador que conecta el formulario seria el siguiente en el cual se sigue la estructura dada de la division del backcon el front 

\begin{figure}[h!]
    \centering
    % ¡IMPORTANTE! Cambia 'Img/nueva_imagen.png' por la ruta real de tu imagen
    \includegraphics[width=0.4\textwidth]{Img/vista.png}
\end{figure}

% --- FIN: SECCIÓN DE IMAGEN ADICIONAL ---


\section*{Enlace a repositorio en github}
\url{https://github.com/irvingorozco23/taller_3-formulario.git}

\textit{codigo de overlife esta en el repositorio con el nombre de principal 2vista
}
